...
public class paint extends Application {
	...
	// 	Rectangle rec = new Rectangle(100, 100, 50, 100);
	// 	circle.setFill(Color.CYAN);
	// //	Stage stage2 = new Stage();
	// 	Button btn = new Button(100, 200, "Yee");
	// 	btn.setOnAction(e -> System.out.println("lmao"));
		

	// 	//stage2.setTitle("lol");
	// 	//stage2.setScene(new Scene(btn, 100, 100));
	...
	// 	pane.getChildren().add(rec);
		...
		// HBox box2 = new HBox();
		// HBox box3 = new HBox();
		// Text a = new Text("box1");
		// Text b = new Text("box2");
		// Text c = new Text("box3");
		// pane.getChildren().addAll(box1, box2, box3);
		// box1.getChildren().add(a);
		// 	box2.getChildren().add(b);
		...
		// primaryStage.show();
		primaryStage.setTitle("Exam3 JavaFX");
		VBox v = new VBox();
		...
		p.getChildren().add(rectangle2);
		Button b = new Button("Click");
		HBox hBox = new HBox(b);
